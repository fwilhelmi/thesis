...
\begin{document}
	...
	\begin{table}[t!]
		\footnotesize
		\caption{Comparison of wireless network simulators.}
		...
		\resizebox{\columnwidth}{!}{\begin{tabular}{@{}ccccccc@{}}
				...
				ns-3      & Yes         & C++                                                       & High       & No\footnotemark[1]                                                        & Partial                                                 & No\footnotemark[2]                                                         \\
		...
		\end{tabular}}
	\end{table}
	\footnotetext[2]{\label{note1}Although ns-2 and ns-3 do not provide a default graphical animation tool, there are tools supporting live animation, e.g., PyViz or NetAnim for ns-3 and NAM for ns-2.}
    \footnotetext[3]{blueAn integration with OpenAI Gym has been recently provided to ns-3 \cite{gawlowicz2018ns3}, but the ML-based operation is not part of the simulator.}  
	...
	\begin{figure*}[ht!]
		...
		\begin{subfigure}{0.35\textwidth}
			\includegraphics[width=\linewidth]{toy_scenario_2a.pdf}
			\caption{Topology of \textit{Sce2a.}} \label{fig:x_a}
		\end{subfigure}
		\hspace{0.1mm}
		\begin{subfigure}{0.24\textwidth}
			...
			\end{tikzpicture}
			\caption{CTMN of \textit{Sce2a.}} \label{fig:c_a}
		\end{subfigure}
		%\hspace*{\fill}
		\\
		\begin{subfigure}{0.35\textwidth}
			\includegraphics[width=\linewidth]{toy_scenario_2b.pdf}
			\caption{Topology of \textit{Sce2b}.} \label{fig:x_b}
		\end{subfigure}
		\hspace{0.1mm}
		\begin{subfigure}{0.24\textwidth}
			\begin{tikzpicture}[<->,>=stealth',shorten >=1pt,auto,node distance=1.8cm,
			...
			(S4) edge (S6);
			\end{tikzpicture}
			\caption{CTMN of \textit{Sce2b}.} \label{fig:c_b}
		\end{subfigure}
		% 2nd row: 3 more subfigures
		\\%\vspace*{5mm}
		\begin{subfigure}{0.35\textwidth}
			\includegraphics[width=\linewidth]{toy_scenario_2c.pdf}
			\caption{Topology of \textit{Sce2c}.} \label{fig:x_c}
		\end{subfigure}
		%\hspace*{\fill}
		\begin{subfigure}{0.24\textwidth}
			\begin{tikzpicture}[<->,>=stealth',shorten >=1pt,auto,node distance=1.8cm,
			...
			\end{tikzpicture}
			\caption{CTMN of \textit{Sce2c}.} \label{fig:c_c}
		\end{subfigure}
		\\
		%\hspace*{\fill}
		\begin{subfigure}{0.35\textwidth}
			\includegraphics[width=\linewidth]{toy_scenario_2d.pdf}
			\caption{Topology of \textit{Sce2d}.} \label{fig:x_d}
		\end{subfigure}
		%\hspace*{\fill}
		\begin{subfigure}{0.24\textwidth}
			\begin{tikzpicture}[<->,>=stealth',shorten >=1pt,auto,node distance=1.8cm,
