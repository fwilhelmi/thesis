...
\begin{figure}[ht!]
	\centering
	\subfigure[Scenario]{\label{fig:11ax_bss_coloring_a}\includegraphics[width=0.45\textwidth]{fig_2a}}%
	%\hspace{1cm}%
	\subfigure[Packets exchange]{\label{fig:11ax_bss_coloring_b}\includegraphics[width=0.5\textwidth]{fig_4b}}
...
\begin{figure*}[ht!]
	\centering
	\subfigure[Scenario]{\label{fig:fig_5_a}\includegraphics[width=0.4\textwidth]{fig_5_a}}
	\hspace{1cm}
	\subfigure[Packets exchange]{\label{fig:fig_5_b}\includegraphics[width=.5\columnwidth]{fig_5_b}}
...
\begin{figure*}[h!]
	\centering
	% Situation 1
	\subfigure[Sensing area (OBSS/PD = -82 dBm)]{\label{fig:cs_toy_scenario_1a}\includegraphics[width=0.4\textwidth]{fig_15a}}
	\hspace{1cm}
	% CTMN 1
	\subfigure[CTMN (OBSS/PD = -82 dBm)]{\label{fig:ctmn_toy_scenario_1a}\includegraphics[width=0.4\textwidth]{ctmn_toy_scenario_1a}}\\
	% Situation 2
...
%\begin{figure}[ht!]
%	\centering
%	\subfigure[CTMN representation]{\label{fig:ctmn_toy_scenario_1c}\includegraphics[width=.9\textwidth]{ctmn_toy_scenario_1c}}
...
\begin{figure}[ht!]
	\centering
	\subfigure[Scenario]{\label{fig:toy_scenario_2}\includegraphics[width=0.38\textwidth]{fig_18}}%
	\hspace{1cm}%
	\subfigure[Results]{\label{fig:SIM_1_3_individual}\includegraphics[width=.52\columnwidth]{SIM_1_2}}
...
\begin{figure}[ht!]
	...
	\subfigure[Throughput]{\includegraphics[width=.6\textwidth]{SIM_2_2_2}\label{fig:SIM_2_2_2}}%
	\subfigure[Channel occupancy]{\includegraphics[width=.6\textwidth]{SIM_2_2_1}\label{fig:SIM_2_2_1}}
...
\begin{figure*}[ht!]
	\centering		
	\subfigure[BSS$_A$]{\includegraphics[width=.55\columnwidth]{SIM_2_3_1}\label{fig:SIM_2_3_1}}%
	\subfigure[Others]{\includegraphics[width=.55\columnwidth]{SIM_2_3_2}\label{fig:SIM_2_3_2}}
...
\begin{figure*}[ht!]
	\centering		
	\subfigure[Scenario]{\includegraphics[width=0.4\textwidth]{sr_and_tb}\label{fig:sr_and_tb_a}}
